...
const Footer = () => {
  return (
    <div className='bg'>
      ...
      <div className='p-5 row align-items-center justify-content-center'>
       <div className='col-lg-6'>
        ...
        <div className='col-lg-8'>
          ...
          <button type='btn' className='btn btn-primary ms-3 py-3 px-3'>Sign in</button>
        </div>
        <div className="col-lg-2"></div>
       </div>
      ...
      <p className='text-center text-light'>Flavorsome - August 2025 Alwin Joseph Dsilva</p>
